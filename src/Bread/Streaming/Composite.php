...
class Composite extends Event\Emitter implements Interfaces\Readable, Interfaces\Writable
{
    use Traits\Pipe;
    ...
    public function __construct(Interfaces\Readable $readable, Interfaces\Writable $writable)
    {
